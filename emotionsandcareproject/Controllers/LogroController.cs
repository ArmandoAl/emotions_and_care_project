...
namespace API.Controllers
{
    ...
    {
        private readonly ILogroService _service;

        public LogroController(ILogroService service)
        {
            _service = service;
        }

        [HttpPost]
        public ActionResult Add(Logro logro)
        {
        ...
        [HttpPut]
        public ActionResult Update(Logro logro)
        {
            if (logro == null) return BadRequest();
