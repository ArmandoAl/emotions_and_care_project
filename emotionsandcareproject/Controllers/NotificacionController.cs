...
namespace API.Controllers
{
    ...
    public class NotificacionController : Controller
    {
        ...
        public NotificacionController(INotificacionService service, 
              IPacienteService pacienteService, IEspecialistaService especialistaService
            )
        {
            _service = service;
        ...
        public async Task<ActionResult> Add([FromBody] Notificacion notificacion, [FromRoute] int idPaciente)
        {
        ...
        [HttpPut]
        public Task<ActionResult> Update(Notificacion notificacion)
        {
